...
fun SplashScreen(navController: NavController) {
    ...
    LaunchedEffect(key1 = true, block = {
        ...
        navController.navigate(NewsNavigation.HomeScreen.name + "/$defaultNews")
...
//        navController.navigate(NewsNavigation.HomeScreen.name + "/$defaultNews")
    ...
    Surface(modifier = Modifier
        ...
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.bolt ),
                contentDescription = "sunny icon",
                contentScale = ContentScale.Fit,
                modifier = Modifier.size(95.dp).background(color = MaterialTheme.colorScheme.onBackground))

            Text(text = "Distinguish What right for you?",
